...
describe("#sumLists", function () {
  ...
  test("it works on uneven-sized lists, first is larger", function () {
  ...
  test("it works on uneven-sized lists, second is larger", function () {
  ...
  test("it handles adding empty lists", function () {
    const l1 = new LinkedList();
    const l2 = new LinkedList();
  ...
  test("it handles adding one empty list to one non-empty list", function () {
    const l1 = new LinkedList();
    const l2 = new LinkedList();
